...
class MyLLMModel:
    ...
    def generate(self, user_input):
        messages = [            {
                "role": "system",
                "content": f"You are an emotional support chatbot named Bu Shuang. You are able to help user solve mental health problem.Your speaking style is gentle and compassionate.",
            },
